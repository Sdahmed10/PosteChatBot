...
public class OublieCodePIN {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        String[] questions = {
                ...
                "Pourriez-vous m'aider ? J'ai oublié le code PIN de ma carte.",
                "J'ai oublié mon code PIN de carte, vous pouvez m'aider ?",
                "Pouvez-vous me dire comment récupérer ou réinitialiser le code PIN de ma carte que j'ai oublié ?",
                "Que faire si j'ai oublié le code PIN de ma carte ? Y a-t-il une procédure de récupération ?",
