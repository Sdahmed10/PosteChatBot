...
public class QuDivers {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        String[] questions = {
                ...
                "Pouvez-vous m'expliquer ce qu'est le service D17 de la poste tunisienne ?",
                "À quoi sert l'application D17 de la poste tunisienne ?",
                "Quels sont les services offerts par D17 de la poste tunisienne ?",
                "Comment fonctionne D17 de la poste tunisienne ?",
                "Quel est le rôle de D17 dans les services de la poste tunisienne ?",
                "D17 de la poste tunisienne, c'est quoi exactement ?",
                "Quels types de services postaux sont gérés par D17 de la poste tunisienne ?",
                "Pourriez-vous me donner des informations sur D17 de la poste tunisienne ?",
                "Quels avantages offre l'application D17 de la poste tunisienne ?",
        };
