...
public class ConsultationHistoriqueD17 {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        String[] questions = {
                ...
                "Peut-on consulter l'historique de la carte via D17 ?",
                "Est-il possible de vérifier l'historique de la carte en utilisant D17 ?",
                "On peut voir l'historique de la carte avec D17, non ?",
                "Pourriez-vous me confirmer si D17 permet de consulter l'historique de la carte ?",
                "D17 offre-t-il la possibilité de consulter l'historique des transactions de la carte, et si oui, comment cela fonctionne-t-il ?",
