...
public class IMF {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        String[] questions = {
                ...
                "Quelle IMF puis-je payer par D17 ?",
                "Pouvez-vous me préciser quelles Institutions de Microfinance peuvent être réglées via D17 ?",
                "Avec D17, je peux payer quelles IMF ?",
                "Pouvez-vous me fournir une liste des IMF que je peux régler par D17 ?",
                "Quels sont les établissements de microfinance acceptant les paiements par D17, et comment puis-je effectuer ces paiements ?",
