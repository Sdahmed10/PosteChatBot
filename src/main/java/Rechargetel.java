...
public class Rechargetel {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        String[] questions = {
                ...
                "Comment recharger mon téléphone via D17 ?",
                "Pourriez-vous m'expliquer la procédure pour recharger un téléphone en utilisant D17 ?",
                "Comment je fais pour recharger mon téléphone avec D17 ?",
                "Pouvez-vous me dire comment procéder pour effectuer un rechargement de téléphone via D17 ?",
                "Quelle est la démarche à suivre pour recharger mon téléphone en utilisant D17, et y a-t-il des étapes spécifiques à suivre ?",
