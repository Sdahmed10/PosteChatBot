...
public class EncaissementMandat {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        String[] questions = {
                ...
                "Comment encaisser un mandat ?",
                "Pourriez-vous m'expliquer la procédure pour encaisser un mandat ?",
                "Comment je fais pour encaisser un mandat ?",
                "Pouvez-vous me dire comment procéder pour encaisser un mandat ?",
                "Quelle est la démarche à suivre pour encaisser un mandat et où puis-je le faire ?",
