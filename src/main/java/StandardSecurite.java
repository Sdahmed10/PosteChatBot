...
public class StandardSecurite {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        String[] questions = {
                ...
                "D17 est-elle protégée par des standards de sécurité reconnus ?",
                "Pouvez-vous confirmer si D17 respecte des standards de sécurité reconnus ?",
                "D17 est-elle sécurisée selon des normes reconnues ?",
                "Pourriez-vous me dire si D17 utilise des standards de sécurité éprouvés ?",
                "Quels sont les standards de sécurité appliqués à D17, et est-ce que ces standards sont reconnus dans l’industrie ?",
