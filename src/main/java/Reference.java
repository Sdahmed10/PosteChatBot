...
public class Reference {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        String[] questions = {
                ...
                "J’ai envoyé un mandat, mais je n’ai pas de référence. Que faire ?",
                "Pourriez-vous me conseiller sur la marche à suivre si j’ai envoyé un mandat sans avoir reçu de référence ?",
                "J’ai envoyé un mandat mais je n’ai pas de référence, comment je fais ?",
                "Pouvez-vous me dire ce que je dois faire si j’ai envoyé un mandat et que je n’ai pas de référence ?",
                "Que dois-je faire si j’ai envoyé un mandat et que je n’ai pas de numéro de référence ? Y a-t-il une procédure pour retrouver ou vérifier cet envoi ?",
