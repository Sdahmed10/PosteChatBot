...
public class ConsulatationCCP {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        String[] questions = {
                ...
                "Puis-je consulter mon compte CCP en utilisant le D17 ?",
                "Est-ce que je peux voir mon compte CCP avec le D17 ?",
                "Peut-on consulter un compte CCP via D17 ?",
                "Le D17 permet-il de consulter les informations de mon compte CCP ?",
                "J’aimerais savoir si le D17 me permet de vérifier les détails de mon compte CCP. Est-ce possible ?",
