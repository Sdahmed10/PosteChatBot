...
public class MPQR {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        String[] questions = {
                ...
                "Qu'est-ce que MPQR ?",
                "Pourriez-vous m'expliquer ce qu'est MPQR ?",
                "C’est quoi exactement MPQR ?",
                "Pouvez-vous me dire ce qu'est MPQR et à quoi cela sert ?",
                "Quel est le rôle de MPQR et comment est-il utilisé ?",
                "Comment payer avec MPQR ?",
                "Pourriez-vous m'expliquer comment effectuer un paiement avec MPQR ?",
                "On fait comment pour payer avec MPQR ?",
                "Pouvez-vous me dire comment utiliser MPQR pour payer ?",
                "Quelle est la procédure pour effectuer un paiement avec MPQR ?",
