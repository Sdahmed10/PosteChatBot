...
public class MotdePasseCqoui {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        String[] questions = {
                ...
                "Quel est le mot de passe de D17",
                "Pouvez-vous me fournir le mot de passe pour accéder à D17 ?",
                "C’est quoi le mot de passe pour D17 ?",
                "Pourriez-vous me dire quel est le mot de passe de D17 ?",
                "Quel est le mot de passe nécessaire pour accéder à D17 et comment puis-je l'obtenir ?",
