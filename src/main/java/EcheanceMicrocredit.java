...
public class EcheanceMicrocredit {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        String[] questions = {
                ...
                "Comment payer une échéance de microcrédit ?",
                "Pourriez-vous m'expliquer la procédure pour régler une échéance de microcrédit ?",
                "Comment je fais pour payer une échéance de microcrédit ?",
                "Pouvez-vous me dire comment effectuer le paiement d'une échéance de microcrédit ?",
                "Quelle est la démarche à suivre pour payer une échéance de microcrédit, et quels moyens de paiement sont acceptés ?",
