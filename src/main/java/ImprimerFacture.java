...
public class ImprimerFacture {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        String[] questions = {
                ...
                "Comment imprimer le reçu de paiement de la facture ?",
                "Pourriez-vous m'expliquer comment imprimer le reçu pour le paiement de la facture ?",
                "Comment je fais pour imprimer le reçu de paiement de ma facture ?",
                "Pouvez-vous me dire comment imprimer un reçu après avoir payé une facture ?",
                "Quelle est la procédure pour imprimer un reçu de paiement de facture et quels outils ou logiciels sont nécessaires ?",
