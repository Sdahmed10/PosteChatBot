...
public class limitederechargetelephonique {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        String[] questions = {
                ...
                "Y a-t-il des limites en termes de nombre et de montant pour les recharges téléphoniques ?",
                "Existe-t-il des restrictions sur le nombre et le montant des recharges téléphoniques ?",
                "Peut-on recharger son téléphone sans limite de nombre et de montant ?",
                "Quels sont les plafonds pour le nombre et le montant des recharges téléphoniques ?",
                "Y a-t-il une limite au nombre et au montant des recharges téléphoniques ?",
        };
