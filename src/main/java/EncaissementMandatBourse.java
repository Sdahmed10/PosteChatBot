...
public class EncaissementMandatBourse {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        String[] questions = {
                ...
                "Je n’arrive pas à encaisser un mandat Bourse par D17. Que dois-je faire ?",
                "Pourriez-vous m’aider ? Je rencontre des difficultés pour encaisser un mandat Bourse via D17.",
                "Je n’arrive pas à encaisser un mandat Bourse avec D17, comment je fais ?",
                "Pouvez-vous me dire comment résoudre le problème d’encaissement d’un mandat Bourse par D17 ?",
                "Quel est le processus pour encaisser un mandat Bourse avec D17, et que faire si cela ne fonctionne pas correctement ?",
