...
public class InscriptionD17 {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        String[] questions = {
                ...
                "Quelle est la procédure pour s'inscrire à D17 ?",
                "Quelles sont les étapes pour s'inscrire à D17 ?",
                "Comment créer un compte sur D17 ?",
                "Comment ouvrir un compte sur l’application D17 ?",
                "Comment procéder pour s’inscrire à D17 ?",
                "Comment faire pour s’inscrire à D17 ?",
                "Comment adhérer au service D17 ?",
                "Quels sont les moyens pour s’inscrire à D17 ?",
                "Quelle est la méthode pour s’inscrire à D17 ?",
