...
public class Rechargeunautretel {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        String[] questions = {
                ...
                "Peut-on recharger un autre téléphone mobile ?",
                "Est-il possible de recharger un autre téléphone mobile ?",
                "Y a-t-il un moyen de recharger un autre téléphone mobile ?",
                "Comment peut-on recharger un autre téléphone mobile ?",
                "Existe-t-il une méthode pour recharger un autre téléphone mobile ?",
