...
public class PaiementFacture {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        String[] questions = {
                ...
                "Pourriez-vous m'expliquer la procédure pour payer les factures ?",
                "Comment je fais pour payer mes factures ?",
                "Pouvez-vous me dire quelles sont les étapes pour payer une facture ?",
                "Quelle est la procédure pour régler les factures et quels moyens de paiement sont acceptés ?",
