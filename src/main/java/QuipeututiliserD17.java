...
public class QuipeututiliserD17 {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        String[] questions = {
                "Qui est éligible pour utiliser D17 ?",
                "À qui s'adresse le service D17 ?",
                "Qui a le droit d'utiliser D17 ?",
                "Quels utilisateurs peuvent accéder à D17 ?",
                "Qui peut profiter de l'application D17 ?",
                "Qui est autorisé à utiliser D17 ?",
                "Qui peut bénéficier des services de D17 ?",
                "Pour quel public est destiné D17 ?",
                "Qui peut se servir de l'application D17 ?",
                "Quels types de clients peuvent utiliser D17 ?",
        };
