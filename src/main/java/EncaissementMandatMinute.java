...
public class EncaissementMandatMinute {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        String[] questions = {
                ...
                "Je n’arrive pas à encaisser un mandat minute par D17. Que dois-je faire ?",
                "Pourriez-vous m’assister ? Je rencontre des difficultés pour encaisser un mandat minute via D17.",
                "Je n’arrive pas à encaisser un mandat minute avec D17, comment je fais ?",
                "Pouvez-vous me dire comment résoudre le problème d’encaissement d’un mandat minute par D17 ?",
                "Quel est le processus pour encaisser un mandat minute avec D17 et que faire si cela ne fonctionne pas comme prévu ?",
