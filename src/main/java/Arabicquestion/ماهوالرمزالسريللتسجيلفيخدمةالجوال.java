...
public class ماهوالرمزالسريللتسجيلفيخدمةالجوال {
    public static void main(String[] args) throws InterruptedException {
        ...
        String[] questions = {
                ...
                "ما هو الكود السري المطلوب للتسجيل في خدمة الجوال؟\n",
                "كيف يمكنني الحصول على الرمز السري لتسجيل في خدمة الجوال؟\n",
                "ما هو الرمز السري الذي أحتاجه للتسجيل في خدمة الجوال؟\n",
                "ما هو الرقم السري الذي يتعين استخدامه لتسجيل في خدمة الجوال؟\n",
                "كيف أتمكن من الحصول على الرمز السري لتفعيل خدمة الجوال؟\n" ,
