...
public class يمكنكاستخدامماكينةالصرافالآليالتابعةللبنكلسحبالأموال {
    public static void main(String[] args) throws InterruptedException {
        ...
        String[] questions = {
                ...
                "هل يمكنني استخدام ماكينة الصراف الآلي التابعة للبنك لسحب الأموال؟\n",
                "كيف يمكنني سحب الأموال باستخدام ماكينة الصراف الآلي للبنك؟\n",
                "هل يمكن استخدام ماكينة الصراف الآلي للبنك لإجراء عمليات السحب؟\n",
                "ما هي الطريقة لاستخدام ماكينة الصراف الآلي للبنك لسحب الأموال؟\n",
                "هل يمكن إجراء سحب نقدي من خلال ماكينة الصراف الآلي التابعة للبنك؟\n" ,
