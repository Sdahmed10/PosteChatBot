...
public class لقدفقدتبطاقتيهليمكننيشراءواحدةأخرىبنفسالرقم {
    public static void main(String[] args) throws InterruptedException {
        ...
        String[] questions = {
                ...
                "هل يمكنني الحصول على بطاقة جديدة بنفس الرقم بعد فقدان البطاقة؟\n",
                "ما هي الخطوات للحصول على بطاقة بديلة بنفس الرقم بعد فقدان البطاقة؟\n",
                "هل يمكن إصدار بطاقة جديدة بنفس الرقم إذا فقدت البطاقة الأصلية؟\n",
                "كيف يمكنني استبدال بطاقتي المفقودة ببطاقة جديدة بنفس الرقم؟\n",
                "هل يمكن طلب بطاقة جديدة بنفس الرقم في حالة فقدان البطاقة الحالية؟\n" ,
