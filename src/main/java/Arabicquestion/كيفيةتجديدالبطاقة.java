...
public class كيفيةتجديدالبطاقة {
    public static void main(String[] args) throws InterruptedException {
        ...
        String[] questions = {
                ...
                "كيف يمكنني تجديد بطاقتي؟\n",
                "ما هي خطوات تجديد البطاقة؟\n",
                "كيف يمكنني الحصول على بطاقة جديدة بعد انتهاء صلاحيتها؟\n",
                "ما هي الإجراءات اللازمة لتجديد البطاقة؟\n",
                "كيف أتمكن من تجديد بطاقة دائمة؟\n",
        };
