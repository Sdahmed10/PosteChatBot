...
public class ماهوRIPللبطاقةالذكيةالمستخدمة {
    public static void main(String[] args) throws InterruptedException {
        ...
        String[] questions = {
                ...
                "ما هو رقم RIP للبطاقة الذكية؟\n",
                "كيف يتم تعريف رقم RIP في البطاقة الذكية؟\n",
                "ما هو المقصود برقم RIP في البطاقة الذكية؟\n",
                "ما هي وظيفة رقم RIP في البطاقة الذكية؟\n",
                "ما هو رقم RIP وكيف يُستخدم في البطاقة الذكية؟\n" ,
