...
public class كيفيةإلغاءالاشتراكفيرقميمنالبطاقةالذكية {
    public static void main(String[] args) throws InterruptedException {
        ...
        String[] questions = {
                ...
                "كيف يمكنني إلغاء الاشتراك في رقمي من خلال البطاقة الذكية؟\n",
                "ما هي الخطوات لإلغاء اشتراك رقمي المرتبط بالبطاقة الذكية؟\n",
                "كيف أتمكن من فصل رقم هاتفي عن البطاقة الذكية؟\n",
                "ما هي الطريقة لإلغاء ارتباط رقمي بالبطاقة الذكية؟\n",
                "كيف يمكنني إزالة رقمي من البطاقة الذكية؟\n" ,
