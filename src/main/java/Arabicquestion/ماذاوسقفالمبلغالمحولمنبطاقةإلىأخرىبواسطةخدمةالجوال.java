...
public class ماذاوسقفالمبلغالمحولمنبطاقةإلىأخرىبواسطةخدمةالجوال {
    public static void main(String[] args) throws InterruptedException {
        ...
        String[] questions = {
                ...
                "ما هو الحد الأقصى للمبلغ الذي يمكن تحويله من بطاقة إلى أخرى عبر خدمة الجوال؟\n",
                "كم يمكنني تحويله بين البطاقات باستخدام خدمة الجوال؟\n",
                "ما هي حدود المبالغ التي يمكن تحويلها بين البطاقات باستخدام خدمة الجوال؟\n",
                "ما هو سقف المبالغ المسموح بتحويلها بين البطاقات عبر خدمة الجوال؟\n",
                "ما هو الحد الأقصى للتحويلات المالية بين البطاقات باستخدام خدمة الجوال؟\n" ,
