...
public class ماهوالرمزالذييمكننياستخدامهللدفععبرالإنترنت {
    public static void main(String[] args) throws InterruptedException {
        ...
        String[] questions = {
                ...
                "ما هو الرمز المطلوب للدفع عبر الإنترنت؟\n",
                "كيف يمكنني العثور على الرمز المستخدم للدفع عبر الإنترنت؟\n",
                "ما هو الكود الذي أحتاجه لإجراء مدفوعات عبر الإنترنت؟\n",
                "ما هو الرمز الذي يمكنني استخدامه لإجراء عمليات الدفع عبر الإنترنت؟\n",
                "ما هو الرقم أو الكود الخاص بالدفع عبر الإنترنت؟\nn" ,
