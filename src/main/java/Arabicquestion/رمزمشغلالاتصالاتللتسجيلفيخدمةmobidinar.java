...
public class رمزمشغلالاتصالاتللتسجيلفيخدمةmobidinar {
    public static void main(String[] args) throws InterruptedException {
        ...
        String[] questions = {
                ...
                "ما هو الرمز الخاص بمشغل الاتصالات للتسجيل في خدمة Mobidinar؟\n",
                "كيف يمكنني العثور على رمز مشغل الاتصالات لتسجيل في Mobidinar؟\n",
                "ما هو الكود الذي أحتاجه للتسجيل في خدمة Mobidinar من خلال مشغل الاتصالات؟\n",
                "ما هو رمز التسجيل لمشغل الاتصالات لبدء استخدام خدمة Mobidinar؟\n",
                "كيف يمكنني الحصول على رمز مشغل الاتصالات لتسجيل في خدمة Mobidinar؟\n" ,
