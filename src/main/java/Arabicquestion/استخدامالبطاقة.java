...
public class استخدامالبطاقة {
    public static void main(String[] args) throws InterruptedException {
        ...
        String[] questions = {
                ...
                "كيف يمكنني استخدام بطاقة D17؟",
                "ما هي خطوات استخدام بطاقة D17؟",
                "ما هي الفوائد الأساسية لاستخدام بطاقة D17؟",
                "كيف تتيح لي بطاقة D17 إجراء المدفوعات؟",
                "ما هي مميزات استخدام بطاقة D17 في المعاملات اليومية؟",
