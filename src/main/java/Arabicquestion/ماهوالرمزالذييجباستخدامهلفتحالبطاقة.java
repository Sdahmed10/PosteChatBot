...
public class ماهوالرمزالذييجباستخدامهلفتحالبطاقة {
    public static void main(String[] args) throws InterruptedException {
        ...
        String[] questions = {
                ...
                "ما هو الرمز المطلوب لتفعيل البطاقة؟\n",
                "كيف يمكنني معرفة الرمز لفتح البطاقة؟\n",
                "ما هو الكود الذي أحتاجه لفتح البطاقة؟\n",
                "ما هو الرمز المستخدم لتشغيل البطاقة؟\n",
                "كيف أتمكن من استخدام الرمز لفتح البطاقة؟\n" ,
