...
public class كيفيةفتحالبطاقة {
    public static void main(String[] args) throws InterruptedException {
        ...
        String[] questions = {
                ...
                "كيف يمكنني تفعيل البطاقة؟\n",
                "ما هي الخطوات لفتح أو تفعيل بطاقة جديدة؟\n",
                "كيف أتمكن من تشغيل البطاقة؟\n",
                "ما هي الطريقة لفتح بطاقة الدفع أو البطاقة الذكية؟\n",
                "كيف يمكنني البدء في استخدام البطاقة بعد الحصول عليها؟\n",
