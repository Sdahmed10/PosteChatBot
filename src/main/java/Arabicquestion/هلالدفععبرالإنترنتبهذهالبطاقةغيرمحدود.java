...
public class هلالدفععبرالإنترنتبهذهالبطاقةغيرمحدود {
    public static void main(String[] args) throws InterruptedException {
        ...
        String[] questions = {
                ...
                "هل هناك حدود للدفع عبر الإنترنت باستخدام هذه البطاقة؟\n",
                "ما هو سقف المبالغ التي يمكن دفعها عبر الإنترنت باستخدام هذه البطاقة؟\n",
                "هل يمكن إجراء عمليات دفع غير محدودة عبر الإنترنت باستخدام هذه البطاقة؟\n",
                "هل هناك قيود على المبالغ التي يمكن دفعها عبر الإنترنت بواسطة هذه البطاقة؟\n",
                "ما هي الحدود القصوى للدفع عبر الإنترنت باستخدام هذه البطاقة؟\n" ,
