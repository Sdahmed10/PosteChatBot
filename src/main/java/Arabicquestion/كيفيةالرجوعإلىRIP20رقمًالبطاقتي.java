...
public class كيفيةالرجوعإلىRIP20رقمًالبطاقتي {
    public static void main(String[] args) throws InterruptedException {
        ...
        String[] questions = {
                ...
                "كيف يمكنني استرجاع رقم RIP المكون من 20 رقمًا لبطاقتي؟\n",
                "ما هي الخطوات للعثور على رقم RIP لبطاقتي؟\n",
                "كيف أتمكن من الحصول على رقم RIP المكون من 20 رقمًا لبطاقتي؟\n",
                "ما هي الطريقة للرجوع إلى رقم RIP الخاص ببطاقتي؟\n",
                "كيف يمكنني العثور على رقم RIP (20 رقمًا) لبطاقتي؟\n" ,
        };
