...
public class كيفيةتعبئةالبطاقةدونالاتصالبمكتبالبريد {
    public static void main(String[] args) throws InterruptedException {
        ...
        String[] questions = {
                ...
                "كيف يمكنني تعبئة بطاقتي دون زيارة مكتب البريد؟\n",
                "ما هي الطرق المتاحة لتعبئة البطاقة بدون الذهاب إلى مكتب البريد؟\n",
                "هل هناك وسيلة لتعبئة البطاقة إلكترونيًا دون الحاجة لمكتب البريد؟\n",
                "ما هي الطرق البديلة لتعبئة البطاقة دون التعامل مع مكتب البريد؟\n",
                "كيف يمكنني إضافة رصيد إلى بطاقتي دون الحاجة إلى مكتب البريد؟\n" ,
