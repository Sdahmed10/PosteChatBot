...
public class ماهوالحدالأدنىلشحنالبطاقةعلىمستوىالمكتب {
    public static void main(String[] args) throws InterruptedException {
        ...
        String[] questions = {
                ...
                "ما هو أقل مبلغ يمكن شحنه للبطاقة في المكتب؟\n",
                "ما هو الحد الأدنى لمقدار الشحن الذي يمكن إجراؤه في المكتب؟\n",
                "كم هو أقل رصيد يمكن إضافته إلى البطاقة في المكتب؟\n",
                "ما هو الحد الأدنى لمبلغ الشحن الذي يقبله المكتب للبطاقة؟\n",
                "ما هو الحد الأدنى لمبلغ الشحن المطلوب للبطاقة في المكتب؟\n" ,
