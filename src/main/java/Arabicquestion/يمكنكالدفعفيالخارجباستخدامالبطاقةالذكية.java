...
public class يمكنكالدفعفيالخارجباستخدامالبطاقةالذكية {
    public static void main(String[] args) throws InterruptedException {
        ...
        String[] questions = {
                ...
                "هل يمكن استخدام البطاقة الذكية للدفع في الخارج؟\n",
                "كيف يمكنني استخدام البطاقة الذكية لإجراء عمليات الدفع الدولية؟\n",
                "هل يمكن للبطاقة الذكية أن تُستخدم في المعاملات المالية خارج البلاد؟\n",
                "ما هي الإجراءات المطلوبة لدفع الأموال بالخارج باستخدام البطاقة الذكية؟\n",
                "هل البطاقة الذكية صالحة للدفع في المتاجر والمواقع الدولية؟\n",
