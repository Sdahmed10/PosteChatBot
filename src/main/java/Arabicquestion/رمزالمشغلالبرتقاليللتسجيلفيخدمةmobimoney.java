...
public class رمزالمشغلالبرتقاليللتسجيلفيخدمةmobimoney {
    public static void main(String[] args) throws InterruptedException {
        ...
        String[] questions = {
                ...
                "ما هو رمز المشغل البرتقالي للتسجيل في خدمة Mobimoney؟\n",
                "كيف يمكنني الحصول على رمز المشغل البرتقالي لتسجيل في خدمة Mobimoney؟\n",
                "ما هو الكود المطلوب للتسجيل في خدمة Mobimoney عبر المشغل البرتقالي؟\n",
                "ما هو رمز التسجيل لمشغل البرتقالي للانضمام إلى خدمة Mobimoney؟\n",
                "كيف يمكنني العثور على رمز المشغل البرتقالي لتسجيل في Mobimoney؟\n" ,
        };
