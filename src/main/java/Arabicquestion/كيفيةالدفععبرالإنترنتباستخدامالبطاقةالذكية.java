...
public class كيفيةالدفععبرالإنترنتباستخدامالبطاقةالذكية {
    public static void main(String[] args) throws InterruptedException {
        ...
        String[] questions = {
                ...
                "كيف يمكنني إجراء مدفوعات عبر الإنترنت باستخدام البطاقة الذكية؟\n",
                "ما هي الخطوات للدفع عبر الإنترنت باستخدام البطاقة الذكية؟\n",
                "كيف أتمكن من استخدام البطاقة الذكية لإجراء عمليات الدفع عبر الإنترنت؟\n",
                "ما هي الطريقة الصحيحة لاستخدام البطاقة الذكية للدفع على الإنترنت؟\n",
                "كيف يمكنني استخدام البطاقة الذكية لإتمام عمليات الشراء عبر الإنترنت؟\n" ,
