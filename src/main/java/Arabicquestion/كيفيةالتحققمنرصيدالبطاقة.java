...
public class كيفيةالتحققمنرصيدالبطاقة {
    public static void main(String[] args) throws InterruptedException {
        ...
        String[] questions = {
                ...
                "كيف يمكنني معرفة رصيد بطاقتي؟\n",
                "ما هي الخطوات للتحقق من رصيد البطاقة؟\n",
                "كيف أستطيع التحقق من الرصيد المتبقي على البطاقة؟\n",
                "ما هي الطريقة لمعرفة رصيد بطاقة الدفع؟\n",
                "كيف يمكنني فحص رصيد بطاقتي الذكية؟\n",
