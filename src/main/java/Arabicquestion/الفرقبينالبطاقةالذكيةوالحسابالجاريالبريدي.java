...
public class الفرقبينالبطاقةالذكيةوالحسابالجاريالبريدي {
    public static void main(String[] args) throws InterruptedException {
        ...
        String[] questions = {
                ...
                "ما هو الفرق بين البطاقة الذكية والحساب الجاري البريدي؟\n",
                "كيف تختلف البطاقة الذكية عن الحساب الجاري البريدي؟\n",
                "ما هي الفروقات الرئيسية بين البطاقة الذكية والحساب الجاري البريدي؟\n",
                "كيف يمكن مقارنة البطاقة الذكية بالحساب الجاري البريدي من حيث الاستخدام؟\n",
                "ما هي الاختلافات بين البطاقة الذكية والحساب الجاري البريدي في الخدمات المقدمة؟\n" ,
