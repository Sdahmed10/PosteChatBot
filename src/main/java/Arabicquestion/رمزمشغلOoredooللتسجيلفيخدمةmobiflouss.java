...
public class رمزمشغلOoredooللتسجيلفيخدمةmobiflouss {
    public static void main(String[] args) throws InterruptedException {
        ...
        String[] questions = {
                ...
                "ما هو رمز Ooredoo للتسجيل في خدمة Mobiflouss؟\n",
                "كيف يمكنني العثور على رمز Ooredoo لتسجيل في خدمة Mobiflouss؟\n",
                "ما هو الكود الذي أحتاجه للتسجيل في خدمة Mobiflouss من خلال Ooredoo؟\n",
                "ما هو رمز التسجيل لمشغل Ooredoo للانضمام إلى خدمة Mobiflouss؟\n",
                "كيف يمكنني الحصول على رمز Ooredoo للتسجيل في خدمة Mobiflouss؟\n" ,
        };
