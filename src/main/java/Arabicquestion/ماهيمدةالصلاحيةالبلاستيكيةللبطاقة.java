...
public class ماهيمدةالصلاحيةالبلاستيكيةللبطاقة {
    public static void main(String[] args) throws InterruptedException {
        ...
        String[] questions = {
                ...
                "كم هي فترة صلاحية البطاقة البلاستيكية؟\n",
                "ما هي مدة صلاحية البطاقة البلاستيكية قبل انتهائها؟\n",
                "كم تدوم صلاحية البطاقة البلاستيكية؟\n",
                "ما هي مدة الصلاحية المعتمدة للبطاقة البلاستيكية؟\n",
                "ما هي الفترة التي تبقى فيها البطاقة البلاستيكية صالحة للاستخدام؟\n" ,
