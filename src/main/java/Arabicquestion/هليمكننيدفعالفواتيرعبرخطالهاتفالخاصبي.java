...
public class هليمكننيدفعالفواتيرعبرخطالهاتفالخاصبي {
    public static void main(String[] args) throws InterruptedException {
        ...
        String[] questions = {
                ...
                "هل يمكنني استخدام خط الهاتف لدفع الفواتير؟\n",
                "كيف يمكنني تسديد الفواتير عبر الهاتف؟\n",
                "هل تتيح خدمة الهاتف دفع الفواتير؟\n",
                "ما هي الطريقة لدفع الفواتير من خلال خط الهاتف الخاص بي؟\n",
                "هل يمكن دفع الفواتير عبر الهاتف المحمول؟\n" ,
