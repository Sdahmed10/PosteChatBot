...
public class هليمكنتحويلالأموالمنالبطاقةالذكيةإلىالبطاقةالمصرفية {
    public static void main(String[] args) throws InterruptedException {
        ...
        String[] questions = {
                ...
                "هل يمكن نقل الأموال من البطاقة الذكية إلى البطاقة المصرفية؟\n",
                "هل يمكن تحويل الأموال من بطاقة ذكية إلى حساب مصرفي؟\n",
                "ما هي الطريقة لتحويل الأموال من البطاقة الذكية إلى بطاقة مصرفية؟\n",
                "هل يمكن إجراء تحويلات مالية من البطاقة الذكية إلى بطاقة مصرفية؟\n",
                "كيف يمكن تحويل الأموال من البطاقة الذكية إلى حساب مصرفي؟\n" ,
