...
public class ماهيالأوراقالمطلوبةلشراءالبطاقةالذكية {
    public static void main(String[] args) throws InterruptedException {
        ...
        String[] questions = {
                ...
                "ما هي الوثائق اللازمة للحصول على البطاقة الذكية؟\n",
                "ما هي المستندات المطلوبة لشراء البطاقة الذكية؟\n",
                "ما هي الأوراق التي يجب تقديمها لشراء البطاقة الذكية؟\n",
                "ما هي المتطلبات الوثائقية لشراء البطاقة الذكية؟\n",
                "ما هي الشروط الورقية للحصول على البطاقة الذكية؟\n",
