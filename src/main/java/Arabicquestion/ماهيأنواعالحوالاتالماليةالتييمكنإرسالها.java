...
public class ماهيأنواعالحوالاتالماليةالتييمكنإرسالها {
    public static void main(String[] args) throws InterruptedException {
        ...
        String[] questions = {
                ...
                "ما هي الأنواع المختلفة من الحوالات المالية التي يمكن إرسالها؟\n",
                "ما هي الخيارات المتاحة لإرسال حوالات مالية؟\n",
                "ما هي الفئات المختلفة من الحوالات المالية التي يمكن التعامل معها؟\n",
                "ما هي أنواع الحوالات المالية المتاحة للإرسال؟\n",
                "ما هي تصنيفات الحوالات المالية التي يمكن إرسالها؟\n" ,
