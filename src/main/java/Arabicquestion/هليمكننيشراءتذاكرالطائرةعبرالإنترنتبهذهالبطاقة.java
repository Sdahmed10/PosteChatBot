...
public class هليمكننيشراءتذاكرالطائرةعبرالإنترنتبهذهالبطاقة {
    public static void main(String[] args) throws InterruptedException {
        ...
        String[] questions = {
                ...
                "هل يمكن استخدام هذه البطاقة لشراء تذاكر الطائرة عبر الإنترنت؟\n",
                "كيف يمكنني استخدام البطاقة لشراء تذاكر الطائرة على الإنترنت؟\n",
                "هل يمكن الدفع لتذاكر الطائرة عبر الإنترنت باستخدام هذه البطاقة؟\n",
                "ما هي الطريقة لشراء تذاكر الطائرة عبر الإنترنت باستخدام هذه البطاقة؟\n",
                "هل يمكن استخدام هذه البطاقة لإجراء عمليات شراء تذاكر الطائرة عبر الإنترنت؟\n" ,
