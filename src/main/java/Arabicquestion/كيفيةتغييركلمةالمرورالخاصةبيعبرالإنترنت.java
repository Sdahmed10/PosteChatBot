...
public class كيفيةتغييركلمةالمرورالخاصةبيعبرالإنترنت {
    public static void main(String[] args) throws InterruptedException {
        ...
        String[] questions = {
                ...
                "كيف يمكنني تحديث كلمة المرور الخاصة بي عبر الإنترنت؟\n",
                "ما هي الخطوات لتغيير كلمة المرور الخاصة بي عبر الإنترنت؟\n",
                "كيف أتمكن من إعادة تعيين كلمة المرور الخاصة بي على الإنترنت؟\n",
                "ما هي الطريقة لتغيير كلمة المرور الخاصة بحسابي عبر الإنترنت؟\n",
                "كيف يمكنني تعديل كلمة المرور الخاصة بي باستخدام الإنترنت؟\n" ,
