...
public class صلاحيةالانترنتللبطاقة {
    public static void main(String[] args) throws InterruptedException {
        ...
        String[] questions = {
                ...
                "ما هي مدة صلاحية الإنترنت للبطاقة؟\n",
                "كم تدوم فترة صلاحية خدمة الإنترنت على البطاقة؟\n",
                "ما هو وقت انتهاء صلاحية الإنترنت المتاح على البطاقة؟\n",
                "ما هي الفترة التي تبقى فيها خدمة الإنترنت على البطاقة صالحة؟\n",
                "كم هي مدة صلاحية الإنترنت التي توفرها البطاقة؟\n" ,
