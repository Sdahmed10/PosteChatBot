...
public class كيفيةالتحققمنتاريخالبطاقة {
    public static void main(String[] args) throws InterruptedException {
        ...
        String[] questions = {
                ...
                "كيف يمكنني معرفة تاريخ انتهاء صلاحية البطاقة؟\n",
                "ما هي الطريقة للتحقق من تاريخ البطاقة؟\n",
                "كيف أستطيع معرفة تاريخ انتهاء بطاقة الدفع؟\n",
                "ما هي الخطوات لعرض تاريخ صلاحية البطاقة؟\n",
                "كيف أتمكن من التحقق من تاريخ انتهاء صلاحية بطاقتي؟\n",
