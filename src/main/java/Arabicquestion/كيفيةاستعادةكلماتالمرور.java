...
public class كيفيةاستعادةكلماتالمرور {
    public static void main(String[] args) throws InterruptedException {
        ...
        String[] questions = {
                ...
                "كيف يمكنني استرجاع كلمة المرور الخاصة بي؟\n",
                "ما هي خطوات استعادة كلمة المرور؟\n",
                "كيف يمكن إعادة تعيين كلمة المرور إذا نسيتها؟\n",
                "ما هي الطريقة لاستعادة كلمة المرور المفقودة؟\n",
                "كيف يمكنني استعادة الوصول إلى حسابي إذا نسيت كلمة المرور؟\n",
