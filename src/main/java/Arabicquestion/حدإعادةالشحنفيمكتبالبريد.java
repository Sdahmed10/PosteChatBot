...
public class حدإعادةالشحنفيمكتبالبريد {
    public static void main(String[] args) throws InterruptedException {
        ...
        String[] questions = {
                ...
                "ما هو الحد الأقصى لإعادة الشحن في مكتب البريد؟\n",
                "كم يمكنني إعادة شحنه في مكتب البريد؟\n",
                "ما هو سقف المبلغ الذي يمكن إعادة شحنه في مكتب البريد؟\n",
                "ما هو الحد المسموح به لإعادة الشحن في مكاتب البريد؟\n",
                "ما هو المبلغ الأقصى الذي يمكن إعادة شحنه في مكتب البريد؟\n" ,
