...
public class هليمكننيإعادةشحنبطاقتيمنخلالماكينةالصرافالآلي {
    public static void main(String[] args) throws InterruptedException {
        ...
        String[] questions = {
                ...
                "هل يمكن استخدام ماكينة الصراف الآلي لإعادة شحن بطاقتي؟\n",
                "كيف يمكنني إعادة شحن بطاقتي عبر ماكينة الصراف الآلي؟\n",
                "هل تتيح ماكينة الصراف الآلي عملية شحن البطاقة؟\n",
                "ما هي الخطوات لإعادة شحن البطاقة باستخدام ماكينة الصراف الآلي؟\n",
                "هل يمكنني إضافة رصيد إلى بطاقتي من خلال ماكينة الصراف الآلي؟\n" ,
