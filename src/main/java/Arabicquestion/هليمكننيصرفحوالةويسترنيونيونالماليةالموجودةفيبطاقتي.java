...
public class هليمكننيصرفحوالةويسترنيونيونالماليةالموجودةفيبطاقتي {
    public static void main(String[] args) throws InterruptedException {
        ...
        String[] questions = {
                ...
                "هل يمكنني تحويل حوالة ويسترن يونيون المالية من بطاقتي؟\n",
                "كيف يمكنني صرف حوالة ويسترن يونيون المالية الموجودة على بطاقتي؟\n",
                "هل أستطيع سحب الأموال من حوالة ويسترن يونيون التي تم استلامها عبر بطاقتي؟\n",
                "ما هي الطريقة لصرف حوالة ويسترن يونيون المالية الموجودة على بطاقتي؟\n",
                "هل يمكن استخدام بطاقتي لصرف حوالة ويسترن يونيون المالية؟\n" ,
