...
public class يمكنإرسالالحوالاتالماليةعنطريقالبطاقة {
    public static void main(String[] args) throws InterruptedException {
        ...
        String[] questions = {
                ...
                "هل يمكن استخدام البطاقة لإرسال حوالات مالية؟\n",
                "هل يمكن إرسال حوالات مالية من خلال البطاقة؟\n",
                "كيف يمكن إرسال حوالات مالية باستخدام البطاقة؟\n",
                "ما هي الطريقة لإرسال حوالات مالية عبر البطاقة؟\n",
                "هل تتيح البطاقة إرسال حوالات مالية؟\n",
