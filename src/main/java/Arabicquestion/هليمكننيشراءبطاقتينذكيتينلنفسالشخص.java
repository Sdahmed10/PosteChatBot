...
public class هليمكننيشراءبطاقتينذكيتينلنفسالشخص {
    public static void main(String[] args) throws InterruptedException {
        ...
        String[] questions = {
                ...
                "هل يمكنني شراء أكثر من بطاقة ذكية لشخص واحد؟\n",
                "هل يسمح بشراء بطاقتين ذكيتين لنفس الشخص؟\n",
                "ما هي القواعد بشأن شراء بطاقتين ذكيتين لنفس الفرد؟\n",
                "هل يمكن إصدار بطاقتين ذكيتين لنفس الشخص؟\n",
                "هل يمكن الحصول على بطاقتين ذكيتين لشخص واحد في نفس الوقت؟\n" ,
