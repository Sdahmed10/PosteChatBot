...
public class هليمكننيدفعالفواتيرإلكترونياًباستخدامالبطاقةالذكية {
    public static void main(String[] args) throws InterruptedException {
        ...
        String[] questions = {
                ...
                "هل يمكن استخدام البطاقة الذكية لدفع الفواتير إلكترونياً؟\n",
                "كيف يمكنني دفع الفواتير عبر الإنترنت باستخدام البطاقة الذكية؟\n",
                "هل تتيح البطاقة الذكية دفع الفواتير بشكل إلكتروني؟\n",
                "ما هي الطريقة لدفع الفواتير إلكترونياً باستخدام البطاقة الذكية؟\n",
                "هل يمكن تسديد الفواتير إلكترونياً من خلال البطاقة الذكية؟\n" ,
