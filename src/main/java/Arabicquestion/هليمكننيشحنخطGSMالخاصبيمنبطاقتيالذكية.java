...
public class هليمكننيشحنخطGSMالخاصبيمنبطاقتيالذكية {
    public static void main(String[] args) throws InterruptedException {
        ...
        String[] questions = {
                ...
                "هل يمكن استخدام البطاقة الذكية لشحن خط GSM الخاص بي؟\n",
                "كيف يمكنني شحن خط GSM من خلال بطاقتي الذكية؟\n",
                "هل تتيح البطاقة الذكية إمكانية شحن خطوط GSM؟\n",
                "ما هي الطريقة لشحن خط GSM باستخدام البطاقة الذكية؟\n",
                "هل يمكنني إضافة رصيد لخط GSM باستخدام بطاقتي الذكية؟\n" ,
