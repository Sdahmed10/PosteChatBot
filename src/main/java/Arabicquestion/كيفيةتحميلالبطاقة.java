...
public class كيفيةتحميلالبطاقة {
    public static void main(String[] args) throws InterruptedException {
        ...
        String[] questions = {
                ...
                "كيف يمكنني تعبئة رصيد البطاقة؟\n",
                "ما هي الخطوات لتحميل البطاقة بالرصيد؟\n",
                "كيف أستطيع إضافة رصيد إلى بطاقتي؟\n",
                "ما هي الطريقة لتحميل البطاقة بالمال؟\n",
                "كيف يمكنني شحن البطاقة بالرصيد المطلوب؟\n",
