...
public class هليمكنناصرفالحوالاتالمالية {
    public static void main(String[] args) throws InterruptedException {
        ...
        String[] questions = {
                ...
                "هل يمكن تحويل الحوالات المالية إلى نقد؟\n",
                "هل يمكن صرف الحوالات المالية نقدًا؟\n",
                "ما هي الإجراءات لصرف الحوالات المالية؟\n",
                "هل يمكن استبدال الحوالات المالية بالنقد؟\n",
                "هل يمكن الحصول على نقود مقابل الحوالات المالية؟\n",
