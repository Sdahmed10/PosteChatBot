...
public class يمكنكزيادةحدالسحب {
    public static void main(String[] args) throws InterruptedException {
        ...
        String[] questions = {
                ...
                "هل يمكن زيادة حد السحب الخاص بي؟\n",
                "كيف يمكنني رفع حد السحب من حسابي؟\n",
                "هل يوجد إمكانية لزيادة حد السحب؟\n",
                "ما هي الإجراءات اللازمة لزيادة حد السحب؟\n",
                "كيف يمكن تعديل حد السحب لزيادة المبلغ المسموح به؟\n" ,
        };
