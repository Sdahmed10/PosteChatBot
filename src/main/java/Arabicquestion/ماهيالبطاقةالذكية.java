...
public class ماهيالبطاقةالذكية {
    public static void main(String[] args) throws InterruptedException {
        ...
        String[] questions = {
                ...
                "هل يمكن أن تشرح لي ما هي البطاقة الذكية؟",
                "كيف يمكنك تعريف البطاقة الذكية؟",
                "ما المقصود بالبطاقة الذكية؟",
                "ماذا يعني مصطلح \"البطاقة الذكية”؟",
