...
public class يمكننياستخدامالبطاقةالذكيةلدفعTPE {
    public static void main(String[] args) throws InterruptedException {
        ...
        String[] questions = {
                ...
                "هل يمكن استخدام البطاقة الذكية لدفع TPE؟\n",
                "كيف يمكنني استخدام البطاقة الذكية لدفع TPE؟\n",
                "هل تتيح البطاقة الذكية إمكانية دفع TPE؟\n",
                "ما هي الطريقة لدفع TPE باستخدام البطاقة الذكية؟\n",
                "هل يمكن استخدام البطاقة الذكية لإجراء مدفوعات لـ TPE؟\n" ,
