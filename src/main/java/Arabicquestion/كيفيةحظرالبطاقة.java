...
public class كيفيةحظرالبطاقة {
    public static void main(String[] args) throws InterruptedException {
        ...
        String[] questions = {
                ...
                "كيف يمكنني إيقاف أو حظر بطاقتي؟\n",
                "ما هي الخطوات اللازمة لحظر بطاقة الدفع؟\n",
                "كيف أتمكن من إلغاء تفعيل البطاقة؟\n",
                "ما هي الإجراءات المطلوبة لحظر البطاقة؟\n",
                "كيف يمكنني طلب حظر بطاقة في حالة فقدانها أو سرقتها؟\n",
