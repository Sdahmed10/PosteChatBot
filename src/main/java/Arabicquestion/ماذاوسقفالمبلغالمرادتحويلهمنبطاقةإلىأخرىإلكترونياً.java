...
public class ماذاوسقفالمبلغالمرادتحويلهمنبطاقةإلىأخرىإلكترونياً {
    public static void main(String[] args) throws InterruptedException {
        ...
        String[] questions = {
                ...
                "ما هو الحد الأقصى للمبلغ الذي يمكن تحويله بين البطاقات إلكترونيًا؟\n",
                "كم هو سقف المبلغ الذي يمكن نقله من بطاقة إلى أخرى عبر الإنترنت؟\n",
                "ما هو المبلغ الأقصى المسموح به للتحويل بين البطاقات إلكترونيًا؟\n",
                "ما هي الحدود القصوى للمبالغ التي يمكن تحويلها بين البطاقات بشكل إلكتروني؟\n",
                "ما هو سقف التحويلات المالية الإلكترونية بين البطاقات؟\n" ,
