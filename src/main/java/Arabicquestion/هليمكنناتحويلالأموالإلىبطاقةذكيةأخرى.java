...
public class هليمكنناتحويلالأموالإلىبطاقةذكيةأخرى {
    public static void main(String[] args) throws InterruptedException {
        ...
        String[] questions = {
                ...
                "هل يمكن إرسال الأموال إلى بطاقة ذكية أخرى؟\n",
                "هل يمكن تحويل الأموال بين البطاقات الذكية؟\n",
                "كيف يمكن تحويل الأموال إلى بطاقة ذكية مختلفة؟\n",
                "ما هي الطريقة لتحويل الأموال إلى بطاقة ذكية أخرى؟\n",
                "هل تتيح البطاقة تحويل الأموال إلى بطاقات ذكية أخرى؟\n" ,
