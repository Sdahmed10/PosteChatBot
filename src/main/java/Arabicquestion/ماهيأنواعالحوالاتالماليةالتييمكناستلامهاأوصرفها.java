...
public class ماهيأنواعالحوالاتالماليةالتييمكناستلامهاأوصرفها {
    public static void main(String[] args) throws InterruptedException {
        ...
        String[] questions = {
                ...
                "ما هي الأنواع المختلفة من الحوالات المالية التي يمكن استلامها أو صرفها؟\n",
                "ما هي الخيارات المتاحة لاستلام أو صرف الحوالات المالية؟\n",
                "ما هي الفئات المختلفة من الحوالات المالية التي يمكن التعامل معها؟\n",
                "ما هي أنواع الحوالات المالية التي يمكن استلامها أو صرفها؟\n",
                "ما هي التصنيفات المختلفة للحوالات المالية التي يمكن استلامها أو صرفها؟\n" ,
