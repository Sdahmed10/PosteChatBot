...
public class TelchargerD17 {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        String[] questions = {
                ...
                "Comment puis-je télécharger l’application D17 ?",
                "Quelle est la procédure pour télécharger l’application D17 ?",
                "Quelles sont les étapes pour télécharger l’application D17 ?",
                "Comment obtenir l’application D17 ?",
                "Comment installer l’application D17 sur mon téléphone ?",
                "Où puis-je trouver l’application D17 pour la télécharger ?",
                "Comment accéder au téléchargement de l’application D17 ?",
                "Quels sont les moyens de télécharger l’application D17 ?",
                "Comment peut-on télécharger l’application D17 ?",
                "Quelle est la méthode pour télécharger l’application D17 ?",
